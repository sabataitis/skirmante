---
title: about
seo_title: About Skirmante - Solution Focused Coach
seo_description: >-
  Skirmante's journey of becoming a solution focused coach for wellbeing, goals,
...
blocks:
  ...
  - blocks:
      - card_heading: ''
        ...
        _template: card
      - text: |
          [Accreditation](https://www.erickson.edu/en/home)
        alignment: center
        image:
          src: /uploads/erickson badge icon.webp
          alt: Erickson badge
          size: medium
          radius: rounded-none
        order: reverse
        _template: card
      - text: >
          [Cooperation](https://www.coachfinder.nl/coach/skirmante-sabataityte/#about)
        alignment: center
        image:
          src: /uploads/coachfinder.webp
          alt: Coachfinder member
          size: small
          radius: rounded-none
        order: reverse
        _template: card
