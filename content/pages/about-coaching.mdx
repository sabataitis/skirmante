...
blocks:
  ...
  - card_heading: What's next?
    text: |
      [Learn about coaching methods I use](https://skirmante.com/formula)

      [Check out my services](https://skirmante.com/services)

      [Enjoy free resources](https://skirmantesolutionfocus.substack.com/)
    bgc: '#7E22CE'
    buttons:
