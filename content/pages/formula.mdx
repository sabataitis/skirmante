---
title: formula
seo_title: Formula For Coaching Sessions| Skirmante.com
seo_description: >-
  Coaching sessions are tailored around your desired oucome and emerges from
  solution focused approach in coaching. Powered with some neuroscience informed
  tools and practices for wellbeing, success, learning, setting and achieving
  goals.
blocks:
  - image_block_size: full
    image:
      src: /uploads/fomula final.webp
  ...
  - text: >
      ...
      **applied neuroscience** for well-being, performance, and goal attainment.
      I
  ...
  - card_heading: 'The key elements of every coaching session:'
    text: >
      **Warm up** – getting our resourcefulness activated. We will always
      explore
      ...
      **Focus** – I encourage you to invite a moment of focus on presence, so
      that you
      ...
      **What** \*\*is your preferred outcome from us talking? \*\*An outcome is
      always formulated in the positive. We may form a
      ...
      **Meaning of the outcome.** Why it matters? This will always be a question
      we need to repeat again, even if
      ...
      **Experience of the presence of the desired outcome.** New ideas and
      solutions cannot be squeezed out with our hard, rational
      ...
      **Invite You to reflect on what unfolds during the session.** The session
      is about you and your awareness, it’s never about what the
      ...
      Invite You to look at **actions, behaviors, commitment** that needs to
      show up to support the goal. This comes solely from you, as a coach I will
      not offer an action plan or suggest solutions.
    bgc: ''
    _template: card
  - image:
      src: /uploads/future cloud.webp
      alt: Solution Focus Illustration Image
    text: ''
    _template: imageBlock
  - card_heading: Solution Focused (SF) Approach to coaching
    ...
    bgc: '#78716C'
    _template: card
  - card_heading: Key ideas I focus on in my work with you
    text: >
      ![](</uploads/polar bear on couch-1.webp>)
      ...
      **Trust.** This is a relationship that requires mutual trust. There is a
      ...
      grows. It grows into roots, deeper into the
      meaning.![](/uploads/expert.webp)
      ...
      **You are an expert of You.** This is the core idea of our coaching
      ...
      ![](/uploads/mindset.webp)


      **Coach mindset** - I don’t hold the answers. When entering our
      conversation it is
      ...
      **Fixing a problem is a limited possibility, instead aim for your
      preferred future.** In my sessions we acknowledge the difficulties and
      from there we focus
      ...
      ![](/uploads/progress.webp)


      **Progress is not only about the future.** We often forget to appreciate
      the resourceful past and the present.
      ...
      ![](/uploads/butterfly.webp)


      **Change is inevitable.** We change all the time, the world changes all
      the time, so thinking
  ...
  - card_heading: Applied Neuroscience in coaching conversations
    text: >
      ...
      inspired me [here.](formula)

      As

      part of my service, I consult about neuroscience tools and some of them

      you can find in the resources. When it comes to coaching, knowing what in
      conversation of the session works well,
    ...
    image:
      src: ''
      alt: Coaching sssion for your polar bear image
      size: small
      radius: rounded-xl
    _template: card
  ...
  - card_heading: Solution Focused approach
    text: >
      * **Elliott Connie**, SFU – Solution Focused Brief Therapy,
      Psychotherapist and trainer. Elliott
      ...
      * **Haesun Moon**, Ph.D., is a communication scientist, an educator, and
      an author. I
      ...
      * \*\*Gin Lalli \*\*Solution Focused Hypnotherapy, Therapist. Gin Lalli
      podcast inspired me to talk more about solution focused approach and how
      it works.
    bgc: '#7E22CE'
    _template: card
  - card_heading: Neuroscience
    text: >
      ...
      * **Lisa Feldman Barrett, PhD**, “is among the top 0.1% most cited
      scientists in the world for her
      ...
      * **Dr. Mathew Walker** is an author, neuroscientist with PhD in
      neurophysiology, and a
        ...
        me, when thinking about well-being, sleep is number one thing - it is
